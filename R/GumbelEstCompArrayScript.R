...
filenames <- c(HF_errors_filename, EM_errors_filename, HF_pars_filename, EM_pars_filename,
               HF_GOF_filename, EM_GOF_filename, runtimes_filename)
...
runtimes <- matrix(c(HFResult$runtime, EMResult$runtime), nrow = 1)
